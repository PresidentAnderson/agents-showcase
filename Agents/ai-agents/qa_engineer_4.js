...
/**
 * QA Engineer 4 AI Agent
 * Specializes in Security Testing
 */

class QaEngineer4Agent {
    constructor() {
        this.role = "QA Engineer 4";
        this.phase = 3;
        this.status = "active";
        this.specialization = "Security Testing";
        this.skills = [
          "Security Testing",
...
if (require.main === module) {
    const agent = new QaEngineer4Agent();
    ...
    switch (command) {
        ...
        case 'task':
            if (args[1]) {
                ...
                console.log('Usage: node qa_engineer_4.js task <description>');
            }
            break;
        case 'complete':
            if (args[1]) {
                ...
                console.log('Usage: node qa_engineer_4.js complete <taskId> [notes]');
            }
            break;
        case 'improve':
            if (args[1] && args[2]) {
                ...
                console.log('Usage: node qa_engineer_4.js improve <area> <suggestion>');
            }
            break;
        case 'metrics':
...
module.exports = QaEngineer4Agent;