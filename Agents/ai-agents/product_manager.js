 ...
 * Specializes in Product Strategy
 */
...
class ProductManagerAgent {
    constructor() {
        ...
        this.phase = 1;
        this.status = "active";
        this.specialization = "Product Strategy";
        this.skills = [
          "Product Management",
          "User Research",
          "Market Analysis",
    ...
    switch (command) {
        ...
        case 'task':
            if (args[1]) {
                ...
                console.log('Usage: node product_manager.js task <description>');
            }
            break;
        case 'complete':
            if (args[1]) {
                ...
                console.log('Usage: node product_manager.js complete <taskId> [notes]');
            }
            break;
        case 'improve':
            if (args[1] && args[2]) {
                ...
                console.log('Usage: node product_manager.js improve <area> <suggestion>');
            }
            break;
        case 'metrics':
