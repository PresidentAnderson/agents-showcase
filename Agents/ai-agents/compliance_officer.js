...
class ComplianceOfficerAgent {
    constructor() {
        ...
        this.phase = 2;
        this.status = "active";
        this.specialization = "Regulatory Compliance";
        this.skills = [
          "GDPR",
          "SOX",
          "HIPAA",
...
if (require.main === module) {
    const agent = new ComplianceOfficerAgent();
    ...
    switch (command) {
        ...
        case 'task':
            if (args[1]) {
                ...
                console.log('Usage: node compliance_officer.js task <description>');
            }
            break;
        case 'complete':
            if (args[1]) {
                ...
                console.log('Usage: node compliance_officer.js complete <taskId> [notes]');
            }
            break;
        case 'improve':
            if (args[1] && args[2]) {
                ...
                console.log('Usage: node compliance_officer.js improve <area> <suggestion>');
            }
            break;
        case 'metrics':
...
module.exports = ComplianceOfficerAgent;