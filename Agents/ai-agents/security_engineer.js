...
class SecurityEngineerAgent {
    constructor() {
        this.role = "Security Engineer";
        this.phase = 1;
        this.status = "active";
        this.specialization = "Application Security";
        this.skills = [
          "OWASP",
          "Security Testing",
          "Penetration Testing",
...
if (require.main === module) {
    const agent = new SecurityEngineerAgent();
    ...
    switch (command) {
        ...
        case 'task':
            if (args[1]) {
                ...
                console.log('Usage: node security_engineer.js task <description>');
            }
            break;
        case 'complete':
            if (args[1]) {
                ...
                console.log('Usage: node security_engineer.js complete <taskId> [notes]');
            }
            break;
        case 'improve':
            if (args[1] && args[2]) {
                ...
                console.log('Usage: node security_engineer.js improve <area> <suggestion>');
            }
            break;
        case 'metrics':
...
module.exports = SecurityEngineerAgent;