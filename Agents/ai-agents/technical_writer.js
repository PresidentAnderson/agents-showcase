...
class TechnicalWriterAgent {
    constructor() {
        this.role = "Technical Writer";
        this.phase = 3;
        this.status = "active";
        this.specialization = "Documentation";
        this.skills = [
          "Technical Writing",
          "API Documentation",
          "User Guides",
    ...
    switch (command) {
        ...
        case 'task':
            if (args[1]) {
                ...
                console.log('Usage: node technical_writer.js task <description>');
            }
            break;
        case 'complete':
            if (args[1]) {
                ...
                console.log('Usage: node technical_writer.js complete <taskId> [notes]');
            }
            break;
        case 'improve':
            if (args[1] && args[2]) {
                ...
                console.log('Usage: node technical_writer.js improve <area> <suggestion>');
            }
            break;
        case 'metrics':
...
module.exports = TechnicalWriterAgent;