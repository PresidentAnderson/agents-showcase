...
/**
 * Security Engineer 2 AI Agent
 * Specializes in Infrastructure Security
 */

class SecurityEngineer2Agent {
    constructor() {
        this.role = "Security Engineer 2";
        this.phase = 3;
        this.status = "active";
        this.specialization = "Infrastructure Security";
        this.skills = [
          "Network Security",
          "Cloud Security",
...
if (require.main === module) {
    const agent = new SecurityEngineer2Agent();
    ...
    switch (command) {
        ...
        case 'task':
            if (args[1]) {
                ...
                console.log('Usage: node security_engineer_2.js task <description>');
            }
            break;
        case 'complete':
            if (args[1]) {
                ...
                console.log('Usage: node security_engineer_2.js complete <taskId> [notes]');
            }
            break;
        case 'improve':
            if (args[1] && args[2]) {
                ...
                console.log('Usage: node security_engineer_2.js improve <area> <suggestion>');
            }
            break;
        case 'metrics':
...
module.exports = SecurityEngineer2Agent;